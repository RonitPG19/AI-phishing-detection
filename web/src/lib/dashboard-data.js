...
export const alerts = [
  { title: "Mismatched Return-Path", detail: "Suspicious relay 'smtp-secure-check.net' flagged in 14 scans", icon: AlertTriangle },
  { title: "Low-entropy Domain Spike", detail: "8 detections from generated-id-9912.co within the last hour", icon: Link2 },
  { title: "PayPal Brand Spoofing", detail: "Forged display name detected from 'service@intl.paypa1.com'", icon: Mail },
  { title: "Oversized PDF Attachment", detail: "Encrypted payload exceeding typical scan depth from unknown sender", icon: FileText }
]
